const fiHeader = `
        ...
        <div class="header__container _container">
          <div class="language">
            <a href="index.html" class="ru nonactive" title="Vaihda venäjän kieleen">RU</a>
            <a href="index-fi.html" class="fi active" title="Nykyinen suomenkielinen versio">FI</a>
            <a href="index-en.html" class="en nonactive" title="Vaihda englannin kieleen">EN</a>
          </div>
          <div class="logo">
            <a class="parrot" href="#" title="Siirry etusivulle">
              <div class="img">
                <img
                  src="src/images/parrotsvg.svg"
                  alt="Venäjän käännöstoimisto Grigori Konopelko logo"
                  loading="lazy"
                />
              </div>
            </a>
            <div class="logo__title">
              <a href="index-fi.html" title="Siirry etusivulle">
          ...
          <div class="header__contacts">
            <div class="header__phone">
              <a href="tel:+79117770297" class="phone" title="Soita numeroon +7 911 777 02 97"
                >+7&nbsp;911&nbsp;777&nbsp;02&nbsp;97</a
              >
            </div>
            <div class="header__mail">
              <a
                ...
                class="mail"
                title="Lähetä sähköpostia osoitteeseen grigori.konopelko@mail.ru"
      ...
      <nav class="menu block">
        <div class="menu__wrapper _container">
          <div class="menu__container">
            ...
            <ul class="menu__list">
              <li class="menu__item home">
                <a href="index-fi.html" class="menu__link" title="Siirry etusivulle">
                  <svg
                    width="44"
                    height="43"
                    viewBox="0 0 44 43"
              ...
              <li class="menu__item interpreting">
                <a href="interpreting-fi.html" class="menu__link" title="Siirry tulkkaus-sivulle"
                  >Tulkkaus</a
                >
              </li>
              <li class="menu__item translation">
                <a href="translation-fi.html" class="menu__link" title="Siirry käännös-sivulle"
                  >Käännös</a
                >
              </li>
              <li class="menu__item cv">
                <a href="cv-fi.html" class="menu__link" title="Siirry tulkki-sivulle">Tulkki</a>
              </li>
              <li class="menu__item questions">
                <a
                  href="questions-fi.html"
                  class="menu__link"
                  title="Siirry usein kysyttyihin kysymyksiin"
                  >Kysymykset</a
                >
              </li>
              <li class="menu__item contact">
                <a href="contacts-fi.html" class="menu__link" title="Siirry yhteystietoihin"
                  >Yhteys</a
                >
              </li>
            </ul>
          ...
          <div class="contacts">
            <a href="tel:+79117770297" class="phone" title="Soita numeroon +7 911 777 02 97">
              <span class="visually-hidden">Soita</span>
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
          ...
          <div class="contacts">
            <a
              ...
              title="Lähetä sähköpostia osoitteeseen grigori.konopelko@mail.ru"
            >
              <span class="visually-hidden">Lähetä sähköpostia</span>
              <svg
                width="39"
                height="29"
                viewBox="0 0 39 29"
        ...
        <div class="footer__container _container">
          <div class="order">
            <p>
              ...
              <a
                ...
                title="Lähetä viesti Telegramissa"
                >Telegram</a
              >
              tai
              <a href="whatsapp://send?phone=+79117770297" title="Lähetä viesti WhatsAppissa"
                >WhatsApp</a
              >.
            </p>
          </div>
          ...
          <ul class="footer__menu">
            <li class="footer__item home">
              <a href="index-fi.html" class="menu__link" title="Siirry etusivulle"
                >&#10144; Venäjän käännöstoimisto Grigori Konopelko</a
              >
            </li>
            <li class="footer__item interpreting">
              <a href="interpreting-fi.html" class="menu__link" title="Siirry tulkkaus-sivulle"
                >&#10144; Venäjän kielen tulkkaukset</a
              >
            </li>
            <li class="footer__item translation">
              <a href="translation-fi.html" class="menu__link" title="Siirry käännös-sivulle"
                >&#10144; Venäjän kielen käännökset</a
              >
            </li>
            <li class="footer__item">
              <a href="cv-fi.html" title="Siirry tulkki-sivulle"
                >&#10144; Venäjän kielen kääntäjä ja tulkki</a
              >
            </li>
            ...
            <li class="footer__item">
              <a
                href="toimeksiannot-fi.html"
                class="menu__link"
                title="Siirry toimeksiantoihin Venäjällä"
